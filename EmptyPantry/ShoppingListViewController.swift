...
class ShoppingListViewController: UITableViewController, AddItemTableViewControllerDelegate{
    ...
    func fetchAllItems(){
        ...
        do{
            ...
            items = result as! [ShoppingListItem]
        } catch {
            print("\(error)")
        }
    }
    ...
    func itemSaved(by controller: AddItemTableViewController, with text: String, at indexPath: NSIndexPath?) {
        ...
        if let ip = indexPath{
            ...
            let item = NSEntityDescription.insertNewObject(forEntityName: "ShoppingListItem", into: managedObjectContext) as! ShoppingListItem
            item.text = text
            items.append(item)
